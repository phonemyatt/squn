 ...
 */
export function buildWindowsAuthOptions(config: WindowsAuth): Record<string, unknown> {
 ...
 */
export function buildWindowsUpnAuthOptions(config: WindowsUpnAuth): Record<string, unknown> {
  return {
    user: config.upn,
