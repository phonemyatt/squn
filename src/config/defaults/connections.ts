import type { AdapterType } from "../types.ts";
...
export const DEV_CONNECTIONS: ConnectionDefaults = {
  postgres: { host: "localhost", port: 5432, database: "squn_dev", user: "postgres" },
...
export const TEST_CONNECTIONS: ConnectionDefaults = {
  postgres: { host: "localhost", port: 5432, database: "squn_test", user: "postgres" },
