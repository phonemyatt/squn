...
const subclasses = [
  { Class: ConnectionError, code: ErrorCode.CONN_UNKNOWN, sibling: QueryError },
  {
    ...
    sibling: ConnectionError,
  },
  { Class: MappingError, code: ErrorCode.NULL_VIOLATION, sibling: QueryError },
  {
    Class: ValidationError,
    code: ErrorCode.PARAM_MISSING,
    sibling: MappingError,
  },
  {
    Class: TransactionError,
    code: ErrorCode.TX_COMMIT_FAILED,
    sibling: ValidationError,
  },
  {
    Class: TimeoutError,
    code: ErrorCode.POOL_QUEUE_FULL,
    sibling: TransactionError,
  },
  {
    Class: AdapterError,
    code: ErrorCode.ADAPTER_NOT_SUPPORTED,
    sibling: TimeoutError,
  },
  {
    Class: ReadonlyViolationError,
    code: ErrorCode.READONLY_WRITE_BLOCKED,
    sibling: AdapterError,
  },
  {
    Class: SecurityError,
    code: ErrorCode.INJECTION_DETECTED,
    sibling: ReadonlyViolationError,
  },
  {
    Class: SqunConfigError,
    code: ErrorCode.CONFIG_MISSING,
    sibling: SecurityError,
  },
